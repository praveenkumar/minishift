...
== Permission cause update to fail

Depending on your operating system if you have minishift binary installed in location where current user does not have write permission then `minishift update` will fail.
